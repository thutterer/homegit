...
plugins=(colored-man fzf-tab magic-enter per-directory-history zsh-syntax-highlighting)
...
# Use `v file.txt` from within a Vim terminal 
# to open file in the same Vim instance
source ${ZSH_CUSTOM}/v.sh
